...
#define SWM_PINASSIGN(n)		MMIO32(SWM_BASE + (n) * 4)
#define SWM_PINASSIGN0			SWM_PINASSIGN(0)
#define SWM_PINASSIGN1			SWM_PINASSIGN(1)
#define SWM_PINASSIGN2			SWM_PINASSIGN(2)
#define SWM_PINASSIGN3			SWM_PINASSIGN(3)
#define SWM_PINASSIGN4			SWM_PINASSIGN(4)
#define SWM_PINASSIGN5			SWM_PINASSIGN(5)
#define SWM_PINASSIGN6			SWM_PINASSIGN(6)
#define SWM_PINASSIGN7			SWM_PINASSIGN(7)
#define SWM_PINASSIGN8			SWM_PINASSIGN(8)
